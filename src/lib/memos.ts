...
export const memos: MemoItem[] = [
    ...
    {
        slug: 'why-i-started-business',
        title: '起業という選択をした理由',
        date: '2026-02-22',
        tags: ['起業', 'AI', 'クリエイター', 'ビジョン'],
        excerpt: '大学卒業を機に起業という選択をしました。なぜ就職ではなく起業なのか、そして今どんな課題に取り組もうとしているのか。自分の考えを整理して書き残しておきます。',
        paragraphs: [
            ...
            '## AIが変えたデジタルの世界',
            '近年のAI技術の進歩は目覚ましく、文章作成、画像生成、コーディング支援など、デジタル領域の多くの作業が自動化できるようになりました。効率化という意味では、ほぼ限界に近いところまで来ていると感じます。',
            '以前は僕もこうした効率化の分野に興味がありました。しかし今は、別の課題に目を向けています。AIの急速な発展によって生まれた、デジタル空間の歪みです。',
            '## 取り残されるクリエイターたち',
            'AIの恩恵を受ける人がいる一方で、深刻な影響を受けている人たちがいます。イラストレーター、写真家、作家、作曲家——デジタルコンテンツを生み出してきたクリエイターたちです。',
            '彼らの多くは、何年、何十年もかけて技術を磨いてきました。しかし今、AIが数秒で「それっぽい」ものを生成できるようになり、その価値が正当に評価されにくくなっています。',
            'さらに問題なのは、彼らの作品が無断でAIの学習データに使われ、その対価も払われていないケースが多いことです。自分の作品がAIに学習され、そのAIが自分の仕事を奪う——これはあまりにも理不尽な構造です。',
            '## AIは過去の技術革新と本質的に違う',
            '「技術革新で職業が変わるのは昔からあったこと。今回も同じだ」という意見があります。確かに、蝋燭職人は電球の登場で仕事を失い、馬車の御者は自動車に取って代わられました。',
            'しかし、AIには決定的な違いがあります。電球は蝋燭がなくても光り続けますが、AIは人間の創作物がなければ成長できません。',
            'AIモデルの性能を維持・向上させるには、常に新しい学習データが必要です。そしてその学習データとは、人間が生み出したコンテンツに他なりません。AIが生成したものだけでAIを学習させると、品質が劣化していくことが研究で明らかになっています。',
            'つまり、構造的に、人間の創作活動はAIにとって不可欠な「入力」なのです。',
            '## 同じ土俵で評価される矛盾',
            'ここに矛盾があります。人間の創作物はAIの存続に不可欠であるにもかかわらず、市場では人間の作品とAI生成物が同じ土俵で比較され、しばしばAI生成物の方が「速い・安い」という理由で選ばれてしまいます。',
            '見た目だけでは、人間が描いたイラストとAIが生成したイラストの区別はつきにくい。しかし、その構造的な価値は全く異なります。人間の創作がなければ、AIは先細りしていくしかないのです。',
            'この事実に気づかないまま、「もう人間が作る意味がない」とクリエイターが諦めていく。それが、僕が考える最大の損失です。',
            '## だから、僕が作りたいもの',
            '人間の創作活動が正当に評価される仕組み。作品の出所や権利が明確に記録され、使われた分だけクリエイターに還元されるインフラ。',
            'これが、今の僕が取り組もうとしている課題です。',
